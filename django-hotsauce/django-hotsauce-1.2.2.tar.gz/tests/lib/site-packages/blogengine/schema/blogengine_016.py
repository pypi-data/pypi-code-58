# Copyright (C) 2007-2009 Jack Bortone <robillard.etienne@gmail.com>
# All rights reserved.
#
...
class Category(E.Entity):
    ...
    def get_items_count(self):
        rv = []
        for item in self.x.category_items():
            rv.extend(item.x.blogentries())
        return len(rv)
...
class CategoryItem(E.Entity):
    ...
    def x_blogentries(self):
        ...
        items = sorted([item for item in self.m.blogentries() if \
            item.published is True], key=attrgetter('pub_date'), reverse=True)
        return items
...
class BlogEntry(E.Entity):
    ...
    #category = f.entity('Category')
    category = f.entity('CategoryItem', required=False)
    ...
    def get_absolute_url(self):
        ...
        return ('blogengine.server.views.details_for_blogentry', (), dict(
...
#E.Comment._sample = [
#    (('Jack Bortone',), ('Pepe is not a pony!',), 
...
#    ('Jack Bortone', ), 'Just a test', 'Long description here'),
#    ('2nd post!', '2009-05-04',
#    ('Jack Bortone', ), '2nd test with notmm-schevo', 'so far so good :)')]
