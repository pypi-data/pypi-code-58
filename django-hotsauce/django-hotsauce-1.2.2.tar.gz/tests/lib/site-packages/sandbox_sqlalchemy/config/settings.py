...
# Keep this to False unless you expecting to debug I18N
USE_I18N = False
...
CUSTOM_ERROR_HANDLERS = (
    ...
    ('handle404', 'sandbox_sqlalchemy.handlers.handle404'),
    ('handle500', 'sandbox_sqlalchemy.handlers.handle500')
    )
...
ROOT_URLCONF = 'sandbox_sqlalchemy.config.urls'
...
SCHEVO_DATABASE_NAME = 'schevo.db.blogs'

ADDTHIS_USERNAME = 'erob'

CACHE_BACKEND_LOCATION = '127.0.0.1:11221'
